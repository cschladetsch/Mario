...
//#endif
		...
		public static void DrawCenteredRect3D(Vector3 p, Vector2 size, Color color)
		{
			DrawCenteredRect3D(p, size, color, Camera.main);
		}
		...
		public static void Label3D(Transform transform, string str)
		{
			Label3D(transform, str, Vector2.zero, Vector2.zero, Camera.current);
		}

		public static void Label3D(Transform transform, string str, Vector2 decal)
		{
			Label3D(transform, str, decal, Vector2.zero, Camera.current);
		}

		public static void Label3D(Transform transform, string str, Vector2 decal, Vector2 size)
		{
			Label3D(transform, str, decal, size, Camera.current);
		}
